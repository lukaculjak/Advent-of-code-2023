...
const strDataTemp = ["4nineeightseven2"];
  ...
  for (let i = 0; i < str.length; i++) {
    switch (str[i]) {
      ...
      case "t":
        ...
        break;
      case "f":
        if (str[i + 1] === "o" && str[i + 2] === "u" && str[i + 3] === "r") {
          tempArray.push("4");
        }

        if (str[i + 1] === "i" && str[i + 2] === "v" && str[i + 3] === "e") {
          tempArray.push("5");
        }
        break;
      case "s":
        if (str[i + 1] === "i" && str[i + 2] === "x") {
          tempArray.push("6");
        }
      ...
      case "n":
        ...
        break;
      default:
        console.log("Just a random character");
    }
  }

  if (tempArray.length === 1) {
    tempArray.push(tempArray[0]);
    tempValue = tempArray[0] + tempArray[1];
    sum += +tempValue;
    tempValue = 0;
    ...
    tempValue = tempArray[0] + tempArray[tempArray.length - 1];
    sum += +tempValue;
    tempValue = 0;
  }
